...
/**
 * Add a dictionary with all {@link SimpleController} route paths.
 */
...
@Dict({
    ...
    SimpleController.ECHO_REGEX_ID,
    SimpleController.ECHO_REGEX_SLUG,
    SimpleController.ECHO_REGEX_VERSION,
    SimpleController.ECHO_REGEX_UUID,
    SimpleController.ECHO_MULTI_VAR,
    SimpleController.ECHO_EXT,
    SimpleController.ECHO_WILDCARD,
    SimpleController.ECHO_OPTIONAL,
    SimpleController.ECHO_NEGOTIATED,
    SimpleController.ECHO_MULTI_ACCEPT,
    SimpleController.ECHO_QUERY_POJO,
    SimpleController.ECHO_STATUS,
    SimpleController.ECHO_OPTIONAL_ID,
    SimpleController.ECHO_STREAM,

})
public @interface SimpleControllerDict {
}
